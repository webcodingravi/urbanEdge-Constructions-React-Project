...
const [mobileSize, setMobileSize] = useState(0)
    ...
    {
        label:"Dashboard",
        icon:<i class="ri-dashboard-2-line mr-2"></i>,
        href:""
    },
      ...
      {
        label:"Projects",
        icon:<i class="ri-building-line mr-2"></i>,
        href:""
    }
            ...
            <div className="bg-white py-4 px-8 flex justify-between items-center">
             <div className="flex gap-4 items-center">
                ...
                <div className="flex gap-2">
                 ...
                 <button className="w-[50px] h-[50px] bg-rose-600 rounded-full object-cover relative" onClick={()=>setProfile(!profile)}>
