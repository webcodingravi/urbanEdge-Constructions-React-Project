   ...
   defaultValues: async() => {
        try{
          ...
          return {
            ...
            construction_type: res.data.data.construction_type,
...
const onSubmit = async(data) => {
    ...
    setLoader(true)
    try{
     const res = await axios.put(`${apiUrl}/projects/${params.id}`,newData,{
         headers : {
             Authorization:`Bearer ${token()}`
         }
     })
    ...
    <>
     <Layout>
        <div className="flex items-center justify-between mt-10 bg-white p-7 rounded-lg">
               ...
               <Link to="/admin/project/list" className="bg-orange-500 px-7 py-3 rounded text-white text-semibold shadow-lg hover:bg-orange-600">
             ...
             <div className="mt-8 bg-white p-8 rounded-lg">
                <form className="md:grid md:grid-cols-2 gap-8" onSubmit={handleSubmit(onSubmit)}>
                      ...
                      <label className="text-gray-600 text-semibold">Slug*</label>
                       <input {
                          ...register('slug',{required:"The slug field is required"})
                           ...
                           <div>
                      <label className="text-gray-600 text-semibold">Construction type</label>
                      <select { ...register("construction_type")} name="construction_type" className="w-full focus:outline-none border p-2.5 rounded mt-3 border-gray-300">
                          <option value="" hidden>Construction Type...</option>
                           ...
                           <option value="Commercial construction">Commerical construction</option>
                            ...
                            <div>
                      <label className="text-gray-600 text-semibold">Sector</label>
                      <select { ...register("sector")} name="sector" className="w-full focus:outline-none border p-2.5 rounded mt-3 border-gray-300">
                  ...
                  />
                   ...
                   <div>
                      <label className="text-gray-600 text-semibold">Location</label>
                       <input {
                          ...register("location")
                       } type="text" name="location" className="w-full focus:outline-none border p-2.5 rounded mt-3 border-gray-300" placeholder="Enter Location"/>
