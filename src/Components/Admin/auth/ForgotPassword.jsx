...
const ForgotPassword = () => {
    ...
    const onSubmit = async (data) => {
        ...
        setLoader(true)
        try {
            const res = await axios.post(`${apiUrl}/forgotPassword`, data, {
        ...
        <>
            <div className="md:min-h-screen py-10">
                <div className="md:w-10/12 mx-auto md:grid md:grid-cols-2 gap-8 items-center px-8 md:px-0">
                    ...
                    <div>
                        <h1 className="font-bold md:text-5xl text-4xl">Forgot Password!</h1>
                        <form className="flex flex-col md:gap-4 gap-4 md:mt-9 mt-7" onSubmit={handleSubmit(onSubmit)}>
