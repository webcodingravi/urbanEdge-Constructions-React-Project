...
const Edit = ({placeholder}) => {
   ...
   const {register,handleSubmit,formState: {errors}} = useForm({
      defaultValues: async() => {
          try{
             const res = await axios.get(`${apiUrl}/articles/${params.id}`,{
               headers : {
   ...
   const onSubmit = async(data) => {
      ...
      setLoader(true)
      try{
          const res = await axios.put(`${apiUrl}/articles/${params.id}`,newData,{
            headers:{
               Authorization: `Bearer ${token()}`
            }
          })
...
const handleFile = async(e) => {
 ...
 return (
    ...
    <Layout>
         ...
         <Link to="/admin/article/list" className="bg-orange-500 px-7 py-3 rounded text-white text-semibold shadow-lg hover:bg-orange-600">
            ...
            />
               ...
               <div className="col-span-2 flex flex-col gap-3">
                  ...
                  <div className="w-[100px]">
                     {
                        articles.image && <img src={`${fileUrl}/uploads/articles/small/${articles.image}`}/>
                     }
                  </div>
                ...
                <div>
                  <label className="text-gray-600 text-semibold">Author</label>
                  <input {
                     ...register('author')
                  } type="text" name="author" className="w-full focus:outline-none border p-2.5 rounded mt-3 border-gray-300" placeholder="Enter Author"/>
