                ...
                <div className="shadow-lg p-8 flex-1">
                   <form className="grid md:grid-cols-2 gap-8">
                      <div className="flex flex-col gap-2">
                        ...
                        <input type="email" name="email"  className="p-2.5 border border-gray-200 focus:outline-none rounded" placeholder="Enter Your Email" required/>
                      </div>

                        <div className="flex flex-col gap-2">
                        <label className="text-gray-600 font-semibold">Phone*</label>
                        <input type="number" name="phone"  className="p-2.5 border border-gray-200 focus:outline-none rounded" placeholder="Enter Your Phone" required/>
                      </div>

                         <div className="flex flex-col gap-2">
                        <label className="text-gray-600 font-semibold">Subject</label>
                        <input type="text" name="subject"  className="p-2.5 border border-gray-200 focus:outline-none rounded" placeholder="Enter Your subject"/>
                      </div>

                       <div className="flex flex-col gap-2 col-span-2">
                        <label className="text-gray-600 font-semibold">Message</label>
                        <textarea rows={10}  name="message"  className="p-2.5 border border-gray-200 focus:outline-none rounded" placeholder="Message" />
                      </div>
