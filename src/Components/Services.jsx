...
const [loader,setLoader] = useState(null);
 ...
 return(
    <>
    <Layout>
        <Hero preHeading="Quality, Integrity Value" heading="Services" description="We excel at transforming visions into reality through outstanding craftsmanship and precise, We excel at transforming visions into reality through outstanding craftsmanship and precise"/>
     ...
     <div className="md:w-10/12 mx-auto px-8 md:px-0">
      ...
      <div className="grid md:grid-cols-3 gap-8 my-8">
            ...
            <div className="relative">
                 <img src={`${fileUrl}/uploads/services/small/${item.image}`} className="cursor-pointer w-full h-full"  />
           ...
           <div className="absolute bottom-0 left-0 md:px-4 px-2 md:my-8  cursor-pointer" >
